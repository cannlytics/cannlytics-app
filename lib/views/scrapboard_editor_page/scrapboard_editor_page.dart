        ...
        children: [
          ...
          if (pageList.isNotEmpty) ...[
            ...
            Padding(
              padding: EdgeInsets.only(
                  left: showSimpleView ? 0 : 240,
                  right: showSimpleView ? 0 : 80),
              child: NoPagesView(),
            ),
          ],
          ...
          if (showSimpleView) ...[
            ...
            if (widget.readOnly == false) ...[
              _MobileScrapPileBtn(
                  onPressed: () => _handleScrapPilePressed(context, bookId)),
            ],
          ]
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (_, constraints) {
        ...
        double bottomPanelHeight = max(
            size.height - (Insets.xl + topPanelHeight + Insets.lg + Insets.xl),
            100);
        return Stack(
          children: [
