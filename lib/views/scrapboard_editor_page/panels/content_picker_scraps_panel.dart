...
import 'package:cannlytics_app/commands/books/delete_scraps_command.dart';
...
import 'package:cannlytics_app/views/scrap_pile_picker/scrap_pile_picker.dart';
...
class _ContentPickerScrapsPanelState extends State<ContentPickerScrapsPanel>
  ...
  void _handleAddPressed([ScrapItem hoverTarget]) {
    List<ScrapItem> scraps =
        _selectedItems.isEmpty ? [hoverTarget] : _selectedItems;
