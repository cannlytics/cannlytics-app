                                ...
                                child: StyledScrollbar(
                                  ...
                                  child: GridView.count(
                                      ...
                                      children: List.generate(
                                        ...
                                        ScrapItem scrap =
                                            bookScraps[scrapIndex];
                                        return ContextMenuRegion(
                                          key: ObjectKey(scrap.documentId),
                                          contextMenu: GenericContextMenu(
                                              labels: state
                                                  .widget.contextMenuLabels
                                                  ?.call(scrap),
                                              actions: state
...
class GridBtn extends StatelessWidget {
  const GridBtn({Key key, this.onPressed, this.bgColor, this.child})
      : super(key: key);
