...
import 'package:cannlytics_app/_utils/notifications/close_notification.dart';
...
import 'package:cannlytics_app/_widgets/positioned_all.dart';
import 'package:cannlytics_app/commands/books/upload_image_scraps_command.dart';
...
class ScrapPilePickerState extends State<ScrapPilePicker>
  ...
  void _handlePickImagesPressed([bool enableCamera = true]) async {
    List<String> paths = await PickImagesCommand()
        .run(allowMultiple: true, enableCamera: enableCamera);
