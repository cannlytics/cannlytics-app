...
import 'package:cannlytics_app/_widgets/sized_and_translated.dart';
...
class _ScrapPopupEditorState extends State<ScrapPopupEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isImage = widget.scrap.contentType == ContentType.Emoji ||
        widget.scrap.contentType == ContentType.Photo;
    if (isImage) {
      row1Height = 0;
      row2Height = 0;
    }
        ...
        child: Stack(fit: StackFit.expand, children: [
          ...
          AnimatedOpacity(
              ...
              child: GestureDetector(
                onTap:
                    () {}, // Swallow any taps on the background so it won't cause the menu to close
                child: TopLeft(
                  child: Container(
                    ...
                    AnimatedOpacity(
                      ...
                      child: SizedAndTranslated(
                          ...
                          offset: Offset(width / 2,
                              row1Height + row2Height + row3Height / 2),
  ...
  AnimatedMenuPanel animatedPanel(Offset o, Size s,
      {double openHeight,
      int index,
      Widget Function(bool isOpen) childBuilder,
  ...
  void _handleAlignChanged(TextAlign value) =>
      widget?.onStyleChanged(scrapStyle.copyWith(align: value));
    ...
    return Padding(
      ...
      child: AnimatedContainer(
          ...
          child: AnimatedSwitcher(
              ...
              child: Padding(
                padding:
                    const EdgeInsets.only(top: 8, left: 6, right: 6, bottom: 2),
                child: child,
              ))),
    );
  }
...
class PanelHeader extends StatelessWidget {
  const PanelHeader({Key key, this.label, this.showBackArrow = true})
      : super(key: key);
  final String label;
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Stack(children: [
        ...
        Center(
            child: Text(label,
                style: TextStyles.caption.copyWith(color: theme.grey))),
      ]),
    );
  }
}
