                ...
                children: [
                  Text("Font",
                      style: TextStyles.caption
                          .copyWith(color: theme.grey, height: 1)),
                ],
              ),
              Expanded(
                child: Center(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                            child: _FontBtn(value,
                                font: BoxFonts.Caveat,
                                onPressed: onFamilyChanged)),
                        HSpace(Insets.sm),
                        Expanded(
                            flex: 2,
                            child: _FontBtn(value,
                                font: BoxFonts.PathwayGothicOne,
                                onPressed: onFamilyChanged)),
                        HSpace(Insets.sm),
                        Expanded(
                            child: _FontBtn(value,
...
class _FontBtn extends StatelessWidget {
  const _FontBtn(this.currentValue, {Key key, this.font, this.onPressed})
      : super(key: key);
  final BoxFonts font;
