          ...
          Column(
            children: [
              ...
              Expanded(
                child: Padding(
                  padding:
                      EdgeInsets.only(top: 4, left: 12, right: 12, bottom: 8),
                      ...
                      (index) => SimpleBtn(
                          ...
                          child: Padding(
                            ...
                            child: _ColorSwatch(swatchColors[index],
                                ...
                                isSelected: swatchColors[index] == value),
                          )),
                    ),
                  ),
                ),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: color,
            border: Border.all(
                color: isSelected ? theme.focus : theme.greyMedium,
        ...
        if (color == Colors.transparent) ...[
          Positioned.fill(
            ...
            child: Transform.rotate(
                angle: pi / 4,
                child: Container(width: size, height: 2, color: theme.grey)),
          )),
        ]
      ],
    );
