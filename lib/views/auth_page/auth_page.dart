...
import 'package:cannlytics_app/commands/app/authenticate_user_command.dart';
import 'package:cannlytics_app/core_packages.dart';
import 'package:cannlytics_app/styled_widgets/styled_load_spinner.dart';
...
class _AuthPageState extends State<AuthPage> with LoadingStateMixin {
          ...
          child: IntrinsicHeight(
            child: Container(
              ...
              padding: EdgeInsets.symmetric(
                  vertical: Insets.lg, horizontal: Insets.med),
  ...
  void _handleSwitchViewPressed() {
    ...
    bool isCreatingAccount = formMode == _AuthFormMode.CreateAccount;
    formMode =
        isCreatingAccount ? _AuthFormMode.SignIn : _AuthFormMode.CreateAccount;
