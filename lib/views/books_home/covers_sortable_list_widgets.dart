...
import 'package:cannlytics_app/_widgets/animated/animated_rotation.dart';
    ...
    return SimpleBtn(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius:
              BorderRadius.horizontal(left: radii[0], right: radii[1]),
        ),
        child: Stack(
          children: [
            Row(
          ...
          child: Row(
            children: [
              SimpleBtn(
                  ...
                  child: Icon(Icons.share, color: theme.surface1)),
              HSpace.lg,
              Text(
                data.title,
  ...
  Widget build(BuildContext context) {
    ...
    return ExcludeFocus(
      ...
      child: Container(
        ...
        padding:
            EdgeInsets.only(bottom: Insets.lg, left: Insets.lg + Insets.sm),
        child:
            Text(text, style: TextStyles.body1.copyWith(color: theme.surface1)),
      ),
    );
  }
}
