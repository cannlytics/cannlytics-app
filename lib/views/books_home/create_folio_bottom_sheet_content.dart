...
class CreateFolioBottomSheetContent extends StatefulWidget {
  ...
  @override
  _CreateFolioBottomSheetContentState createState() =>
      _CreateFolioBottomSheetContentState();
}

class _CreateFolioBottomSheetContentState
    extends State<CreateFolioBottomSheetContent> {
  String _title = "";
  String _desc = "";
  @override
