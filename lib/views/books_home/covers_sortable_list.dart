...
class _CoversSortableListState extends State<CoversSortableList> {
          ...
          Flexible(
            child: LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                ...
                double flexPx = constraints.maxWidth -
                    modifiedWidth -
                    createdWidth -
                    Insets.offset * 2;
                            ...
                            columns: [
                              DataColumn(
                                label: BookColumnHeader("Name",
                                    ...
                                    width: flexPx,
                                    height: 32,
                                    hzAlignment: widget.isMobile
                                        ? BookColumnAlignment.All
                                        : BookColumnAlignment.Left,
                                    sortDir: _currentCol ==
                                            (widget.isMobile
                                                ? ColType.Modified
                                                : ColType.Name)
                              ...
                              DataColumn(
                                label: BookColumnHeader("Last Modified",
                                    onPressed: () =>
                                        _handleColumnPressed(ColType.Modified),
                                    width: modifiedWidth,
                                    height: 32,
                                    hzAlignment: skipCreatedColumn
                                        ? BookColumnAlignment.Right
                                        : BookColumnAlignment.Center,
                                    sortDir: _currentCol == ColType.Modified
                                        ? sortDir
                                        : 0),
                              ),
                              if (!skipCreatedColumn)
                                DataColumn(
                                  label: BookColumnHeader("Date Created",
                                      onPressed: () =>
                                          _handleColumnPressed(ColType.Created),
                                      width: createdWidth,
                                      height: 32,
                                      hzAlignment: BookColumnAlignment.Right,
                                      sortDir: _currentCol == ColType.Created
                                          ? sortDir
                                          : 0),
                                ),
                            ],
                              ...
                              return DataRow(
                                cells: [
                                  ...
                                  if (!skipCreatedColumn)
                                    DataCell(
                                      BookRowItem(
                                          createdWidth, widget.rowHeight, book,
                                          type: ColType.Created,
                                          hzAlignment:
                                              BookColumnAlignment.Right),
                                      onTap: () => _handleRowPressed(book),
                                    ),
  ...
  void _handleRowPressed(ScrapBookData book) =>
