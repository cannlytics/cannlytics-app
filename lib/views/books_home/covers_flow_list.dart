...
import 'package:cannlytics_app/_widgets/animated/auto_fade.dart';
import 'package:cannlytics_app/_widgets/animated/opening_card.dart';
import 'package:cannlytics_app/_widgets/context_menu_overlay.dart';
import 'package:cannlytics_app/_widgets/rounded_card.dart';
...
class _CoversFlowListState extends State<CoversFlowList> {
                    ...
                    child: FocusTraversalGroup(
                      child: ListView.builder(
                        padding: EdgeInsets.symmetric(
                            horizontal: Insets.offset, vertical: Insets.med),
                        ...
                        itemBuilder: (_, index) {
                          ...
                          bool isSelected =
                              data.documentId == _fgBook.documentId;
  ...
  void _selectNextIndex({bool goBack = false}) {
    ...
    int currentIndex = widget.books
        .indexWhere((element) => element.documentId == _fgBook.documentId);
    ...
    _scrollController.animateTo(
        _scrollController.offset + scrollDir * cardSize.width,
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      width: widget.isSelected
          ? widget.closedWidth ?? 0
          : widget.openWidth ?? 0 + gap,
      height: widget.isSelected
          ? widget.closedHeight ?? 0
          : widget.openHeight ?? 0 + gap,
