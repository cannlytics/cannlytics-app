...
import 'package:cannlytics_app/_widgets/mixins/animated_state_mixins.dart';
      ...
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child:
                Container(color: Colors.white.withOpacity(alpha), child: child),
          ),
        ),
      ),
    );
...
class _CollapsingCardState extends State<CollapsingCard>
    with TickerProviderStateMixin, AnimationMixin1 {
  static const double kHeaderHeight = 40;
  bool _isOpen = true;
  double animatedHeightValue(double headerHeight) {
    return headerHeight +
        (widget.height - headerHeight) *
            CurveTween(curve: Curves.easeOut).evaluate(anim1);
  }
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.vertical(
                    ...
                    bottom:
                        Radius.circular(Corners.lg * (1 - animation.value))),
              ),
              child: Row(
                children: [
                  HSpace.sm,
                  ...
                  Text(title.toUpperCase(),
                      style: TextStyles.callout2
                          .copyWith(color: theme.greyStrong)),
