...
class _InlineTextEditorState extends State<InlineTextEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    Size textSize = StringUtils.measure(textToMeasure, widget.style,
          ...
          if (!_isEditing) ...[
            ...
            ContextMenuRegion(
              ...
              contextMenu: GenericContextMenu(
                  labels: ["Edit...", "Copy"],
                  actions: [_handleTextPressed, _handleCopy]),
            ...
            ContextMenuRegion(
              ...
              contextMenu: TextContextMenu(
                  data: _textController.text, controller: _textController),
              child: Container(
