...
//     booksModel.currentBookScraps = List.from(booksModel.currentBookScraps)
//       ..addAll(newScraps);
...
//       String origPath = paths.firstWhere(
//           (element) => element.contains(u.originalFilename),
//           orElse: () => null);
//       double aspect = 1;
//       // Try and calculate the aspect ratio from the file on disk
//       // if (origPath != null && origPath.contains("http") == false) {
//       //   final size =
//       //       image_size.ImageSizeGetter.getSize(FileInput(File(origPath)));
