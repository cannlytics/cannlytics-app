...
import 'package:cannlytics_app/_utils/native_window_utils/window_utils.dart';
import 'package:cannlytics_app/_utils/time_utils.dart';
import 'package:cannlytics_app/commands/app/refresh_menubar_command.dart';
...
class BootstrapCommand extends Commands.BaseAppCommand {
  ...
  void _configureMemoryCache() {
    ...
    if (kIsWeb == false) {
      try {
        // Use some percentage of system ram, but don't fall below the default,
        // in case this returns 0 or some other invalid value.
        cacheSize =
  ...
  void _configureDesktop() {
    ...
    setWindowTitle("Cannlytics");
    Size minSize = Size(600, 700);
    setWindowMinSize(minSize);
    setWindowMaxSize(Size(8192, 8192));
